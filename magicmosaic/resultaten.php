...
<body>
    ...
    <div class="text">
        congratulations! <br>
        you have successfully converted your image <br>
        here is an overview of your results <br>
    </div>
    <img src="convert/output.png" width="100%" >
    <div class="text">
        you can retrieve your photo by clicking
        <a href="convert/output.png">  here </a>
    </div>
    <div class="text">
        you can share your image by clicking on these links &nbsp;&nbsp;
