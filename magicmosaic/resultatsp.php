...
<body>
    ...
    <div class="text">
        Enhorabuena!<br>
        ha convertido con éxito su imagen<br>
        aquí está una vista previa de su resultado <br>
    </div>
    <img src="convert/output.png" width="100%" >
    <div class="text">
        puede recuperar su foto haciendo clic
        <a href="convert/output.png">  aquí </a>
    </div>
    <div class="text">
        puede compartir su imagen haciendo clic en estos enlaces &nbsp;&nbsp;
