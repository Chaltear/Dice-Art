...
<body>
    ...
    <div class="text">
        ...
        Sie haben Ihr Bild erfolgreich konvertiert.<br>
        Hier ist eine Übersicht über Ihre Ergebnisse <br>
    </div>
    <img src="convert/output.png" width="100%" >
    <div class="text">
        können Sie Ihr Foto abrufen, indem Sie auf
        <a href="convert/output.png">  hier </a>
    </div>
    <div class="text">
        Sie können Ihr Bild teilen, indem Sie auf diese Links klicken &nbsp;&nbsp;
